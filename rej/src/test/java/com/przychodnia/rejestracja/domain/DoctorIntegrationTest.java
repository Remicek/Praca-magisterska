...
@BenchmarkMethodChart(filePrefix = "doctorMethodChart")
@BenchmarkHistoryChart( maxRuns = 10, filePrefix = "doctorHistoryChart")
@BenchmarkOptions(benchmarkRounds = 3, warmupRounds = 1)
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml")
@Transactional
@Configurable
public class DoctorIntegrationTest extends AbstractBenchmark{

	@Autowired
    DoctorDataOnDemand dod;
